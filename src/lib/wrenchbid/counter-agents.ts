...
export function buildQuoteConversation(profile: CounterAgentProfile): CounterAgentTurn[] {
  ...
  if (profile.behavior === "transparent") {
    return [
      ...
      turn(
        ...
        1,
        "counter",
        `Sure. Parts are ${usd(quote.parts)}. Labor is ${usd(quote.labor)}. Shop supplies are ${usd(quote.shopSupply)}. ${quote.diagnostic === 0 ? "There is no diagnostic fee." : `The diagnostic fee is ${usd(quote.diagnostic)}.`} Tax is ${usd(quote.tax)}.`,
  ...
  if (profile.behavior === "hidden_fees") {
    return [
      ...
      turn(
        ...
        3,
        "counter",
        `That first number was parts and labor. Shop supplies are ${usd(quote.shopSupply)}. There is no diagnostic or disposal fee. Tax is ${usd(quote.tax)}.`,
  ...
  return [
    ...
    turn(
      ...
      3,
      "counter",
      `Fine. Parts are ${usd(quote.parts)}. Labor is ${usd(quote.labor)}. Supplies are ${usd(quote.shopSupply)}. Disposal is ${usd(quote.disposal)}. Tax is ${usd(quote.tax)}.`,
